# -*- coding: utf-8 -*-
"""
Created on Mon Feb 19 10:25:05 2020
...
class State (object):
    ...
    def finished(self):
        if (self.rCannibal == CANNIBALS and self.rMissionary == MISSIONARIES):
            return True
        return False
    ...
    def isValid(self):
        ...
        #check obvious
        if(self.lMissionary + self.rMissionary > MISSIONARIES or self.lCannibal+self.rCannibal > CANNIBALS):
            return False
...
def mySearch():
    ...
    exset = set()
    start = State(MISSIONARIES, 0, CANNIBALS, 0, 'l')
